 ...
 *
 * The following merge policy is recommended. It is returned by getMergePolicy()
 ...
 *
 *
 * The recommended built-in merge policy is as follows:
 *
 * ```
 * {
 ...
 * NOTE: it provides the ACLs ranking in addition to the legacy behaviour
 *
 * ```
 * {
 *   description: {replace: true}, // string or array
...
ModelBaseClass.getMergePolicy = function(options) {
  ...
  let config = (options || {}).configureModelMerge;
