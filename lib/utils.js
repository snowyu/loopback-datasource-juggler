 ...
 * @param {Object} obj The object to merge with base object
    ...
    if (obj != null && typeof obj === 'object') {
      ...
      Object.keys(obj).forEach(function(key) {
        ...
        if (objValue == null || typeof objValue !== 'object') {
          ...
          if (base == null || typeof base !== 'object' ||
            base[key] == null) {
            // If base is not an object or base item value
            dst[key] = objValue;
          } else {
            dst[key] = deepMerge(base[key], obj[key]);
          }
        }
      });
    }
...
function rankArrayElements(array, rank) {
  ...
  array.forEach(function(el) {
    ...
    // initialize element rank if not set already
    el.__rank = el.__rank || rank;
  });
  return array;
}
